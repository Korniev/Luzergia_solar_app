...
class LineChartSample6 extends StatelessWidget {
  LineChartSample6({
    ...
    Color? line2Color1,
    Color? line2Color2,
  })  : line1Color1 = line1Color1 ?? AppStyles.pantone2,
        line1Color2 = line1Color2 ?? AppStyles.pantone3,
        line2Color1 = line2Color1 ?? AppStyles.pantone4,
        line2Color2 = line2Color2 ?? AppStyles.pantone5 {
        ...
        child: LineChart(
          LineChartData(
              ...
              LineChartBarData(
                ...
                dotData: FlDotData(
                  ...
                  getDotPainter: (spot, percent, barData, index) =>
                    ...
                    radius: 12,
                    color: Colors.transparent,
                    strokeColor: AppStyles.pantone3,
                  ),
                ),
              ),
            ],
            ...
            borderData: FlBorderData(
              show: true,
              border: const Border(
                left: BorderSide(color: AppStyles.mindAro),
                top: BorderSide(color: AppStyles.pantone5),
